...
contract UnhackableWallet {
     ...
     * @return reporter The address that reported the scam
     * @return suspiciousAddress The address that was reported as scam
     * @return description The description of the scam
     * @return evidence The evidence supporting the report
     * @return timestamp When the report was submitted
     * @return votesFor Number of votes supporting the report
     * @return votesAgainst Number of votes against the report
     * @return confirmed Whether the report has been confirmed by DAO
     */
